...
export function Skills() {
  ...
  <img src="icons/tailwind.jpeg" alt="Tailwind" className="size-20 object-contain opacity-60 hover:opacity-100 transition-opacity duration-300" />
  <img src="icons/js.jpeg" alt="JS" className="size-20 object-contain opacity-60 hover:opacity-100 transition-opacity duration-300" />
